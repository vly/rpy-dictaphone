...
% TODO: include references to the learning objectives in this section.
...
This project aims to provide an easy way to audio record and annotate lectures, talks and other presentations. {\color{red}The platform is to be relatively portable, require minimal setup and start-up time... perhaps learning objectives here too}
...
{\color{red}...add research into depth tracking... hardware constraints... time constraints...}
